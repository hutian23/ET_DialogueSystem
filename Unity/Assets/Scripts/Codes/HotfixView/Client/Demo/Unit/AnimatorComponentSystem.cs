...
namespace ET.Client
{
    ...
    public static class AnimatorComponentSystem
    {
        ...
        public static void Play(this AnimatorComponent self, string clipName)
        {
            self.Animator.Play(clipName, 0, 0f);
        }

        public static void Play_Repeat(this AnimatorComponent self, string clipName)
        {
