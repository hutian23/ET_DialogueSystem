...
namespace Timeline.Editor
{
    public class TimelineFieldView: VisualElement, ISelection
    {
        ...
        private Label LocatorFrameLabel { get; set; }
        ...
        public TimelineFieldView()
        {
            ...
            this.LocatorFrameLabel = this.Q<Label>("time-locater-frame-label");
        ...
        public void PopulateView()
        {
            ...
            {
                // TrackView
                TimelineTrackView trackView = Activator.CreateInstance(EditorRegistry.GetTrackViewType(track.GetType())) as TimelineTrackView;
        ...
        private void UpdateTimeLocator()
        {
            ...
            this.LocatorFrameLabel.text = currentTimeLocator.ToString();
        ...
        {
            this.LocatorFrameLabel.style.display = DisplayStyle.Flex;
        }
        ...
        {
            this.LocatorFrameLabel.style.display = DisplayStyle.None;
        }
        ...
        private IEnumerator PlayTimelineCoroutine()
        {
            ...
            {
                SetTimeLocator((int)(counter * 60f));
